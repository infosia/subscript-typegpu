...
function vert(res: Layout, value: Vertex, ctx: VertexInvocation): Varyings { const offset: Offset = res.params.get(); return new Varyings(new Vec4f(value.position.x + offset.value.x, value.position.y + offset.value.y, 0.0, 1.0)); }
