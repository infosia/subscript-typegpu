...
class Declared { input: Storage<Item>; constructor(input: Storage<Item>) { this.input = input; } }
class KernelLayout { input: Storage<Item>; constructor(input: Storage<Item>) { this.input = input; } }
