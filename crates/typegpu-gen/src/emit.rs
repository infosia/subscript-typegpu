...
pub(crate) fn support_module(
    ...
    match (pipelines.is_empty(), render_pipelines.is_empty()) {
        (false, false) => out.push_str("import { BindGroupLayoutSpec, COMPUTE_VISIBILITY, FRAGMENT_VISIBILITY, VERTEX_VISIBILITY, VertexBufferLayoutSpec } from \"./typegpu\";\n\n"),
        (false, true) => out.push_str("import { BindGroupLayoutSpec, COMPUTE_VISIBILITY } from \"./typegpu\";\n\n"),
        (true, false) => out.push_str("import { BindGroupLayoutSpec, FRAGMENT_VISIBILITY, VERTEX_VISIBILITY, VertexBufferLayoutSpec } from \"./typegpu\";\n\n"),
        (true, true) => {}
    }
