...
extern "C" fn coverage_3(out: *mut SubscriptTypegpuInstanceLimits) -> i32 {
    super::coverage_hit(3);
    facade::subscript_typegpu_get_instance_limits(out)
}

extern "C" fn coverage_4(feature: i32) -> bool {
    super::coverage_hit(4);
    facade::subscript_typegpu_has_instance_feature(feature)
}

extern "C" fn coverage_5(
...
extern "C" fn coverage_6(instance: SubscriptTypegpuInstance, future: SubscriptTypegpuFutureId) -> i32 {
    super::coverage_hit(6);
    facade::subscript_typegpu_future_status(instance, future)
}

extern "C" fn coverage_7(instance: SubscriptTypegpuInstance, future: SubscriptTypegpuFutureId) {
...
extern "C" fn coverage_9(adapter: SubscriptTypegpuAdapter, out: *mut SubscriptTypegpuLimits) -> i32 {
...
extern "C" fn coverage_11(adapter: SubscriptTypegpuAdapter, feature: i32) -> bool {
    super::coverage_hit(11);
    facade::subscript_typegpu_adapter_has_feature(adapter, feature)
}

extern "C" fn coverage_12(
    instance: SubscriptTypegpuInstance,
    adapter: SubscriptTypegpuAdapter,
) -> SubscriptTypegpuFutureId {
    super::coverage_hit(12);
    facade::subscript_typegpu_adapter_request_device(instance, adapter)
}

extern "C" fn coverage_13(
    instance: SubscriptTypegpuInstance,
    adapter: SubscriptTypegpuAdapter,
...
extern "C" fn coverage_15(device: SubscriptTypegpuDevice) -> SubscriptTypegpuQueue {
    super::coverage_hit(15);
    facade::subscript_typegpu_device_get_queue(device)
}

extern "C" fn coverage_16(device: SubscriptTypegpuDevice) {
    super::coverage_hit(16);
    facade::subscript_typegpu_device_destroy(device)
}

extern "C" fn coverage_17(device: SubscriptTypegpuDevice, label: SubscriptTypegpuStringView) {
    super::coverage_hit(17);
    facade::subscript_typegpu_device_set_label(device, label)
}

extern "C" fn coverage_18(device: SubscriptTypegpuDevice, filter: i32) {
    super::coverage_hit(18);
    facade::subscript_typegpu_device_push_error_scope(device, filter)
}

extern "C" fn coverage_19(device: SubscriptTypegpuDevice) -> SubscriptTypegpuFutureId {
    super::coverage_hit(19);
    facade::subscript_typegpu_device_pop_error_scope(device)
}

extern "C" fn coverage_20(
    instance: SubscriptTypegpuInstance,
    future: SubscriptTypegpuFutureId,
...
extern "C" fn coverage_23(device: SubscriptTypegpuDevice, out: *mut SubscriptTypegpuLimits) -> i32 {
...
extern "C" fn coverage_25(device: SubscriptTypegpuDevice, feature: i32) -> bool {
...
extern "C" fn coverage_42(queue: SubscriptTypegpuQueue, commands_count: usize, commands: *const SubscriptTypegpuCommandBuffer) {
...
extern "C" fn coverage_47(queue: SubscriptTypegpuQueue, label: SubscriptTypegpuStringView) {
...
extern "C" fn coverage_49(
    buffer: SubscriptTypegpuBuffer,
    mode: u64,
) -> SubscriptTypegpuFutureId {
    super::coverage_hit(49);
    facade::subscript_typegpu_buffer_map_whole_async(buffer, mode)
}

extern "C" fn coverage_50(
    buffer: SubscriptTypegpuBuffer,
    offset: usize,
    outCount: usize,
    out: *mut u8,
...
extern "C" fn coverage_60(texture: SubscriptTypegpuTexture, label: SubscriptTypegpuStringView) {
...
extern "C" fn coverage_62(texture: SubscriptTypegpuTexture) -> u32 {
    super::coverage_hit(62);
    facade::subscript_typegpu_texture_get_height(texture)
}

extern "C" fn coverage_63(texture: SubscriptTypegpuTexture) -> u32 {
    super::coverage_hit(63);
    facade::subscript_typegpu_texture_get_depth_or_array_layers(texture)
}

extern "C" fn coverage_64(texture: SubscriptTypegpuTexture) -> u32 {
    super::coverage_hit(64);
    facade::subscript_typegpu_texture_get_mip_level_count(texture)
}

extern "C" fn coverage_65(texture: SubscriptTypegpuTexture) -> u32 {
    super::coverage_hit(65);
    facade::subscript_typegpu_texture_get_sample_count(texture)
}

extern "C" fn coverage_66(texture: SubscriptTypegpuTexture) -> i32 {
    super::coverage_hit(66);
    facade::subscript_typegpu_texture_get_dimension(texture)
}

extern "C" fn coverage_67(texture: SubscriptTypegpuTexture) -> i32 {
    super::coverage_hit(67);
    facade::subscript_typegpu_texture_get_texture_binding_view_dimension(texture)
}

extern "C" fn coverage_68(texture: SubscriptTypegpuTexture) -> i32 {
    super::coverage_hit(68);
    facade::subscript_typegpu_texture_get_format(texture)
}

extern "C" fn coverage_69(texture: SubscriptTypegpuTexture) -> u64 {
    super::coverage_hit(69);
    facade::subscript_typegpu_texture_get_usage(texture)
}

extern "C" fn coverage_70(texture: SubscriptTypegpuTexture) {
    super::coverage_hit(70);
    facade::subscript_typegpu_texture_destroy(texture)
}

extern "C" fn coverage_71(textureView: SubscriptTypegpuTextureView, label: SubscriptTypegpuStringView) {
    super::coverage_hit(71);
    facade::subscript_typegpu_texture_view_set_label(textureView, label)
}

extern "C" fn coverage_72(sampler: SubscriptTypegpuSampler, label: SubscriptTypegpuStringView) {
    super::coverage_hit(72);
    facade::subscript_typegpu_sampler_set_label(sampler, label)
}

extern "C" fn coverage_73(bindGroupLayout: SubscriptTypegpuBindGroupLayout, label: SubscriptTypegpuStringView) {
    super::coverage_hit(73);
    facade::subscript_typegpu_bind_group_layout_set_label(bindGroupLayout, label)
}

extern "C" fn coverage_74(bindGroup: SubscriptTypegpuBindGroup, label: SubscriptTypegpuStringView) {
    super::coverage_hit(74);
    facade::subscript_typegpu_bind_group_set_label(bindGroup, label)
}

extern "C" fn coverage_75(pipelineLayout: SubscriptTypegpuPipelineLayout, label: SubscriptTypegpuStringView) {
    super::coverage_hit(75);
    facade::subscript_typegpu_pipeline_layout_set_label(pipelineLayout, label)
}

extern "C" fn coverage_76(shaderModule: SubscriptTypegpuShaderModule, label: SubscriptTypegpuStringView) {
    super::coverage_hit(76);
    facade::subscript_typegpu_shader_module_set_label(shaderModule, label)
}

extern "C" fn coverage_77(computePipeline: SubscriptTypegpuComputePipeline, groupIndex: u32) -> SubscriptTypegpuBindGroupLayout {
    super::coverage_hit(77);
    facade::subscript_typegpu_compute_pipeline_get_bind_group_layout(computePipeline, groupIndex)
}

extern "C" fn coverage_78(computePipeline: SubscriptTypegpuComputePipeline, label: SubscriptTypegpuStringView) {
    super::coverage_hit(78);
    facade::subscript_typegpu_compute_pipeline_set_label(computePipeline, label)
}

extern "C" fn coverage_79(renderPipeline: SubscriptTypegpuRenderPipeline, groupIndex: u32) -> SubscriptTypegpuBindGroupLayout {
    super::coverage_hit(79);
    facade::subscript_typegpu_render_pipeline_get_bind_group_layout(renderPipeline, groupIndex)
}

extern "C" fn coverage_80(renderPipeline: SubscriptTypegpuRenderPipeline, label: SubscriptTypegpuStringView) {
    super::coverage_hit(80);
    facade::subscript_typegpu_render_pipeline_set_label(renderPipeline, label)
}

extern "C" fn coverage_81(
...
extern "C" fn coverage_84(commandEncoder: SubscriptTypegpuCommandEncoder, source: SubscriptTypegpuBuffer, sourceOffset: u64, destination: SubscriptTypegpuBuffer, destinationOffset: u64, size: u64) {
...
extern "C" fn coverage_85(commandEncoder: SubscriptTypegpuCommandEncoder, source: *const SubscriptTypegpuTexelCopyBufferInfo, destination: *const SubscriptTypegpuTexelCopyTextureInfo, copySize: *const SubscriptTypegpuExtent3D) {
...
extern "C" fn coverage_86(commandEncoder: SubscriptTypegpuCommandEncoder, source: *const SubscriptTypegpuTexelCopyTextureInfo, destination: *const SubscriptTypegpuTexelCopyBufferInfo, copySize: *const SubscriptTypegpuExtent3D) {
...
extern "C" fn coverage_87(commandEncoder: SubscriptTypegpuCommandEncoder, source: *const SubscriptTypegpuTexelCopyTextureInfo, destination: *const SubscriptTypegpuTexelCopyTextureInfo, copySize: *const SubscriptTypegpuExtent3D) {
...
extern "C" fn coverage_88(commandEncoder: SubscriptTypegpuCommandEncoder, buffer: SubscriptTypegpuBuffer, offset: u64, size: u64) {
    super::coverage_hit(88);
    facade::subscript_typegpu_command_encoder_clear_buffer(commandEncoder, buffer, offset, size)
}

extern "C" fn coverage_89(commandEncoder: SubscriptTypegpuCommandEncoder, querySet: SubscriptTypegpuQuerySet, firstQuery: u32, queryCount: u32, destination: SubscriptTypegpuBuffer, destinationOffset: u64) {
...
extern "C" fn coverage_90(commandEncoder: SubscriptTypegpuCommandEncoder, querySet: SubscriptTypegpuQuerySet, queryIndex: u32) {
    super::coverage_hit(90);
    facade::subscript_typegpu_command_encoder_write_timestamp(commandEncoder, querySet, queryIndex)
}

extern "C" fn coverage_91(commandEncoder: SubscriptTypegpuCommandEncoder, markerLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(91);
    facade::subscript_typegpu_command_encoder_insert_debug_marker(commandEncoder, markerLabel)
}

extern "C" fn coverage_92(commandEncoder: SubscriptTypegpuCommandEncoder, groupLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(92);
    facade::subscript_typegpu_command_encoder_push_debug_group(commandEncoder, groupLabel)
}

extern "C" fn coverage_93(commandEncoder: SubscriptTypegpuCommandEncoder) {
    super::coverage_hit(93);
    facade::subscript_typegpu_command_encoder_pop_debug_group(commandEncoder)
}

extern "C" fn coverage_94(commandEncoder: SubscriptTypegpuCommandEncoder, label: SubscriptTypegpuStringView) {
    super::coverage_hit(94);
    facade::subscript_typegpu_command_encoder_set_label(commandEncoder, label)
}

extern "C" fn coverage_95(computePassEncoder: SubscriptTypegpuComputePassEncoder, pipeline: SubscriptTypegpuComputePipeline) {
    super::coverage_hit(95);
    facade::subscript_typegpu_compute_pass_encoder_set_pipeline(computePassEncoder, pipeline)
}

extern "C" fn coverage_96(computePassEncoder: SubscriptTypegpuComputePassEncoder, groupIndex: u32, group: SubscriptTypegpuBindGroup, dynamicOffsets_count: usize, dynamicOffsets: *const u32) {
...
extern "C" fn coverage_97(computePassEncoder: SubscriptTypegpuComputePassEncoder, workgroupCountX: u32, workgroupCountY: u32, workgroupCountZ: u32) {
...
extern "C" fn coverage_98(computePassEncoder: SubscriptTypegpuComputePassEncoder, indirectBuffer: SubscriptTypegpuBuffer, indirectOffset: u64) {
...
extern "C" fn coverage_99(computePassEncoder: SubscriptTypegpuComputePassEncoder, markerLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(99);
    facade::subscript_typegpu_compute_pass_encoder_insert_debug_marker(computePassEncoder, markerLabel)
}

extern "C" fn coverage_100(computePassEncoder: SubscriptTypegpuComputePassEncoder, groupLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(100);
    facade::subscript_typegpu_compute_pass_encoder_push_debug_group(computePassEncoder, groupLabel)
}

extern "C" fn coverage_101(computePassEncoder: SubscriptTypegpuComputePassEncoder) {
    super::coverage_hit(101);
    facade::subscript_typegpu_compute_pass_encoder_pop_debug_group(computePassEncoder)
}

extern "C" fn coverage_102(computePassEncoder: SubscriptTypegpuComputePassEncoder) {
    super::coverage_hit(102);
    facade::subscript_typegpu_compute_pass_encoder_end(computePassEncoder)
}

extern "C" fn coverage_103(computePassEncoder: SubscriptTypegpuComputePassEncoder, label: SubscriptTypegpuStringView) {
    super::coverage_hit(103);
    facade::subscript_typegpu_compute_pass_encoder_set_label(computePassEncoder, label)
}

extern "C" fn coverage_104(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, pipeline: SubscriptTypegpuRenderPipeline) {
    super::coverage_hit(104);
    facade::subscript_typegpu_render_pass_encoder_set_pipeline(renderPassEncoder, pipeline)
}

extern "C" fn coverage_105(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, groupIndex: u32, group: SubscriptTypegpuBindGroup, dynamicOffsets_count: usize, dynamicOffsets: *const u32) {
...
extern "C" fn coverage_106(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, slot: u32, buffer: SubscriptTypegpuBuffer, offset: u64, size: u64) {
...
extern "C" fn coverage_107(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, buffer: SubscriptTypegpuBuffer, format: i32, offset: u64, size: u64) {
...
extern "C" fn coverage_108(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, vertexCount: u32, instanceCount: u32, firstVertex: u32, firstInstance: u32) {
...
extern "C" fn coverage_109(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, indexCount: u32, instanceCount: u32, firstIndex: u32, baseVertex: i32, firstInstance: u32) {
...
extern "C" fn coverage_110(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, indirectBuffer: SubscriptTypegpuBuffer, indirectOffset: u64) {
...
extern "C" fn coverage_111(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, indirectBuffer: SubscriptTypegpuBuffer, indirectOffset: u64) {
...
extern "C" fn coverage_112(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, x: f32, y: f32, width: f32, height: f32, minDepth: f32, maxDepth: f32) {
...
extern "C" fn coverage_113(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, x: u32, y: u32, width: u32, height: u32) {
    super::coverage_hit(113);
    facade::subscript_typegpu_render_pass_encoder_set_scissor_rect(renderPassEncoder, x, y, width, height)
}

extern "C" fn coverage_114(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, color: *const SubscriptTypegpuColor) {
    super::coverage_hit(114);
    facade::subscript_typegpu_render_pass_encoder_set_blend_constant(renderPassEncoder, color)
}

extern "C" fn coverage_115(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, reference: u32) {
    super::coverage_hit(115);
    facade::subscript_typegpu_render_pass_encoder_set_stencil_reference(renderPassEncoder, reference)
}

extern "C" fn coverage_116(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, queryIndex: u32) {
    super::coverage_hit(116);
    facade::subscript_typegpu_render_pass_encoder_begin_occlusion_query(renderPassEncoder, queryIndex)
}

extern "C" fn coverage_117(renderPassEncoder: SubscriptTypegpuRenderPassEncoder) {
    super::coverage_hit(117);
    facade::subscript_typegpu_render_pass_encoder_end_occlusion_query(renderPassEncoder)
}

extern "C" fn coverage_118(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, bundles_count: usize, bundles: *const SubscriptTypegpuRenderBundle) {
...
extern "C" fn coverage_119(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, markerLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(119);
    facade::subscript_typegpu_render_pass_encoder_insert_debug_marker(renderPassEncoder, markerLabel)
}

extern "C" fn coverage_120(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, groupLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(120);
    facade::subscript_typegpu_render_pass_encoder_push_debug_group(renderPassEncoder, groupLabel)
}

extern "C" fn coverage_121(renderPassEncoder: SubscriptTypegpuRenderPassEncoder) {
    super::coverage_hit(121);
    facade::subscript_typegpu_render_pass_encoder_pop_debug_group(renderPassEncoder)
}

extern "C" fn coverage_122(renderPassEncoder: SubscriptTypegpuRenderPassEncoder) {
    super::coverage_hit(122);
    facade::subscript_typegpu_render_pass_encoder_end(renderPassEncoder)
}

extern "C" fn coverage_123(renderPassEncoder: SubscriptTypegpuRenderPassEncoder, label: SubscriptTypegpuStringView) {
    super::coverage_hit(123);
    facade::subscript_typegpu_render_pass_encoder_set_label(renderPassEncoder, label)
}

extern "C" fn coverage_124(commandBuffer: SubscriptTypegpuCommandBuffer, label: SubscriptTypegpuStringView) {
    super::coverage_hit(124);
    facade::subscript_typegpu_command_buffer_set_label(commandBuffer, label)
}

extern "C" fn coverage_125(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, pipeline: SubscriptTypegpuRenderPipeline) {
    super::coverage_hit(125);
    facade::subscript_typegpu_render_bundle_encoder_set_pipeline(renderBundleEncoder, pipeline)
}

extern "C" fn coverage_126(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, groupIndex: u32, group: SubscriptTypegpuBindGroup, dynamicOffsets_count: usize, dynamicOffsets: *const u32) {
...
extern "C" fn coverage_127(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, slot: u32, buffer: SubscriptTypegpuBuffer, offset: u64, size: u64) {
...
extern "C" fn coverage_128(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, buffer: SubscriptTypegpuBuffer, format: i32, offset: u64, size: u64) {
...
extern "C" fn coverage_129(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, vertexCount: u32, instanceCount: u32, firstVertex: u32, firstInstance: u32) {
...
extern "C" fn coverage_130(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, indexCount: u32, instanceCount: u32, firstIndex: u32, baseVertex: i32, firstInstance: u32) {
...
extern "C" fn coverage_131(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, indirectBuffer: SubscriptTypegpuBuffer, indirectOffset: u64) {
...
extern "C" fn coverage_132(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, indirectBuffer: SubscriptTypegpuBuffer, indirectOffset: u64) {
...
extern "C" fn coverage_133(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, markerLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(133);
    facade::subscript_typegpu_render_bundle_encoder_insert_debug_marker(renderBundleEncoder, markerLabel)
}

extern "C" fn coverage_134(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, groupLabel: SubscriptTypegpuStringView) {
    super::coverage_hit(134);
    facade::subscript_typegpu_render_bundle_encoder_push_debug_group(renderBundleEncoder, groupLabel)
}

extern "C" fn coverage_135(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder) {
    super::coverage_hit(135);
    facade::subscript_typegpu_render_bundle_encoder_pop_debug_group(renderBundleEncoder)
}

extern "C" fn coverage_136(
...
extern "C" fn coverage_137(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder, label: SubscriptTypegpuStringView) {
    super::coverage_hit(137);
    facade::subscript_typegpu_render_bundle_encoder_set_label(renderBundleEncoder, label)
}

extern "C" fn coverage_138(renderBundle: SubscriptTypegpuRenderBundle, label: SubscriptTypegpuStringView) {
    super::coverage_hit(138);
    facade::subscript_typegpu_render_bundle_set_label(renderBundle, label)
}

extern "C" fn coverage_139(querySet: SubscriptTypegpuQuerySet) -> i32 {
    super::coverage_hit(139);
    facade::subscript_typegpu_query_set_get_type(querySet)
}

extern "C" fn coverage_140(querySet: SubscriptTypegpuQuerySet) -> u32 {
    super::coverage_hit(140);
    facade::subscript_typegpu_query_set_get_count(querySet)
}

extern "C" fn coverage_141(querySet: SubscriptTypegpuQuerySet) {
    super::coverage_hit(141);
    facade::subscript_typegpu_query_set_destroy(querySet)
}

extern "C" fn coverage_142(querySet: SubscriptTypegpuQuerySet, label: SubscriptTypegpuStringView) {
    super::coverage_hit(142);
    facade::subscript_typegpu_query_set_set_label(querySet, label)
}

extern "C" fn coverage_143(querySet: SubscriptTypegpuQuerySet) {
    super::coverage_hit(143);
    facade::subscript_typegpu_query_set_release(querySet)
}

extern "C" fn coverage_144(renderBundle: SubscriptTypegpuRenderBundle) {
    super::coverage_hit(144);
    facade::subscript_typegpu_render_bundle_release(renderBundle)
}

extern "C" fn coverage_145(renderBundleEncoder: SubscriptTypegpuRenderBundleEncoder) {
    super::coverage_hit(145);
    facade::subscript_typegpu_render_bundle_encoder_release(renderBundleEncoder)
}

extern "C" fn coverage_146(commandBuffer: SubscriptTypegpuCommandBuffer) {
    super::coverage_hit(146);
    facade::subscript_typegpu_command_buffer_release(commandBuffer)
}

extern "C" fn coverage_147(renderPassEncoder: SubscriptTypegpuRenderPassEncoder) {
    super::coverage_hit(147);
    facade::subscript_typegpu_render_pass_encoder_release(renderPassEncoder)
}

extern "C" fn coverage_148(computePassEncoder: SubscriptTypegpuComputePassEncoder) {
    super::coverage_hit(148);
    facade::subscript_typegpu_compute_pass_encoder_release(computePassEncoder)
}

extern "C" fn coverage_149(commandEncoder: SubscriptTypegpuCommandEncoder) {
    super::coverage_hit(149);
    facade::subscript_typegpu_command_encoder_release(commandEncoder)
}

extern "C" fn coverage_150(renderPipeline: SubscriptTypegpuRenderPipeline) {
    super::coverage_hit(150);
    facade::subscript_typegpu_render_pipeline_release(renderPipeline)
}

extern "C" fn coverage_151(computePipeline: SubscriptTypegpuComputePipeline) {
    super::coverage_hit(151);
    facade::subscript_typegpu_compute_pipeline_release(computePipeline)
}

extern "C" fn coverage_152(shaderModule: SubscriptTypegpuShaderModule) {
    super::coverage_hit(152);
    facade::subscript_typegpu_shader_module_release(shaderModule)
}

extern "C" fn coverage_153(pipelineLayout: SubscriptTypegpuPipelineLayout) {
    super::coverage_hit(153);
    facade::subscript_typegpu_pipeline_layout_release(pipelineLayout)
}

extern "C" fn coverage_154(bindGroup: SubscriptTypegpuBindGroup) {
    super::coverage_hit(154);
    facade::subscript_typegpu_bind_group_release(bindGroup)
}

extern "C" fn coverage_155(bindGroupLayout: SubscriptTypegpuBindGroupLayout) {
    super::coverage_hit(155);
    facade::subscript_typegpu_bind_group_layout_release(bindGroupLayout)
}

extern "C" fn coverage_156(sampler: SubscriptTypegpuSampler) {
    super::coverage_hit(156);
    facade::subscript_typegpu_sampler_release(sampler)
}

extern "C" fn coverage_157(textureView: SubscriptTypegpuTextureView) {
    super::coverage_hit(157);
    facade::subscript_typegpu_texture_view_release(textureView)
}

extern "C" fn coverage_158(texture: SubscriptTypegpuTexture) {
    super::coverage_hit(158);
    facade::subscript_typegpu_texture_release(texture)
}

extern "C" fn coverage_159(buffer: SubscriptTypegpuBuffer) {
    super::coverage_hit(159);
    facade::subscript_typegpu_buffer_release(buffer)
}

extern "C" fn coverage_160(queue: SubscriptTypegpuQueue) {
    super::coverage_hit(160);
    facade::subscript_typegpu_queue_release(queue)
}

extern "C" fn coverage_161(device: SubscriptTypegpuDevice) {
    super::coverage_hit(161);
    facade::subscript_typegpu_device_release(device)
}

extern "C" fn coverage_162(adapter: SubscriptTypegpuAdapter) {
    super::coverage_hit(162);
...
pub fn facade_counting_symbols() -> Vec<(String, *const u8)> {
    vec![
        ...
        ("subscript_typegpu_get_instance_limits".to_owned(), coverage_3 as *const u8),
        ("subscript_typegpu_has_instance_feature".to_owned(), coverage_4 as *const u8),
        ("subscript_typegpu_instance_request_adapter".to_owned(), coverage_5 as *const u8),
        ("subscript_typegpu_future_status".to_owned(), coverage_6 as *const u8),
        ("subscript_typegpu_future_drop".to_owned(), coverage_7 as *const u8),
        ("subscript_typegpu_request_adapter_take".to_owned(), coverage_8 as *const u8),
        ("subscript_typegpu_adapter_get_limits".to_owned(), coverage_9 as *const u8),
        ("subscript_typegpu_adapter_get_info".to_owned(), coverage_10 as *const u8),
        ("subscript_typegpu_adapter_has_feature".to_owned(), coverage_11 as *const u8),
        ("subscript_typegpu_adapter_request_device".to_owned(), coverage_12 as *const u8),
        ("subscript_typegpu_adapter_request_device_with_descriptor".to_owned(), coverage_13 as *const u8),
        ("subscript_typegpu_request_device_take".to_owned(), coverage_14 as *const u8),
        ("subscript_typegpu_device_get_queue".to_owned(), coverage_15 as *const u8),
        ("subscript_typegpu_device_destroy".to_owned(), coverage_16 as *const u8),
        ("subscript_typegpu_device_set_label".to_owned(), coverage_17 as *const u8),
        ("subscript_typegpu_device_push_error_scope".to_owned(), coverage_18 as *const u8),
        ("subscript_typegpu_device_pop_error_scope".to_owned(), coverage_19 as *const u8),
        ("subscript_typegpu_pop_error_scope_take".to_owned(), coverage_20 as *const u8),
        ("subscript_typegpu_device_next_uncaptured_error".to_owned(), coverage_21 as *const u8),
        ("subscript_typegpu_device_lost_info".to_owned(), coverage_22 as *const u8),
        ("subscript_typegpu_device_get_limits".to_owned(), coverage_23 as *const u8),
        ("subscript_typegpu_device_get_adapter_info".to_owned(), coverage_24 as *const u8),
        ("subscript_typegpu_device_has_feature".to_owned(), coverage_25 as *const u8),
        ("subscript_typegpu_device_create_buffer".to_owned(), coverage_26 as *const u8),
        ("subscript_typegpu_device_create_texture".to_owned(), coverage_27 as *const u8),
        ("subscript_typegpu_device_create_sampler".to_owned(), coverage_28 as *const u8),
        ("subscript_typegpu_device_create_bind_group_layout".to_owned(), coverage_29 as *const u8),
        ("subscript_typegpu_device_create_bind_group".to_owned(), coverage_30 as *const u8),
        ("subscript_typegpu_device_create_pipeline_layout".to_owned(), coverage_31 as *const u8),
        ("subscript_typegpu_device_create_shader_module".to_owned(), coverage_32 as *const u8),
        ("subscript_typegpu_device_create_compute_pipeline".to_owned(), coverage_33 as *const u8),
        ("subscript_typegpu_device_create_compute_pipeline_async_begin".to_owned(), coverage_34 as *const u8),
        ("subscript_typegpu_create_compute_pipeline_async_take".to_owned(), coverage_35 as *const u8),
        ("subscript_typegpu_device_create_render_pipeline".to_owned(), coverage_36 as *const u8),
        ("subscript_typegpu_device_create_render_pipeline_async_begin".to_owned(), coverage_37 as *const u8),
        ("subscript_typegpu_create_render_pipeline_async_take".to_owned(), coverage_38 as *const u8),
        ("subscript_typegpu_device_create_command_encoder".to_owned(), coverage_39 as *const u8),
        ("subscript_typegpu_device_create_render_bundle_encoder".to_owned(), coverage_40 as *const u8),
        ("subscript_typegpu_device_create_query_set".to_owned(), coverage_41 as *const u8),
        ("subscript_typegpu_queue_submit".to_owned(), coverage_42 as *const u8),
        ("subscript_typegpu_queue_on_submitted_work_done".to_owned(), coverage_43 as *const u8),
        ("subscript_typegpu_queue_write_buffer".to_owned(), coverage_44 as *const u8),
        ("subscript_typegpu_queue_write_buffer_f32".to_owned(), coverage_45 as *const u8),
        ("subscript_typegpu_queue_write_texture".to_owned(), coverage_46 as *const u8),
        ("subscript_typegpu_queue_set_label".to_owned(), coverage_47 as *const u8),
        ("subscript_typegpu_buffer_map_async".to_owned(), coverage_48 as *const u8),
        ("subscript_typegpu_buffer_map_whole_async".to_owned(), coverage_49 as *const u8),
        ("subscript_typegpu_buffer_read_mapped_range".to_owned(), coverage_50 as *const u8),
        ("subscript_typegpu_buffer_read_mapped_range_f32".to_owned(), coverage_51 as *const u8),
        ("subscript_typegpu_buffer_write_mapped_range".to_owned(), coverage_52 as *const u8),
        ("subscript_typegpu_buffer_set_label".to_owned(), coverage_53 as *const u8),
        ("subscript_typegpu_buffer_get_usage".to_owned(), coverage_54 as *const u8),
        ("subscript_typegpu_buffer_get_size".to_owned(), coverage_55 as *const u8),
        ("subscript_typegpu_buffer_get_map_state".to_owned(), coverage_56 as *const u8),
        ("subscript_typegpu_buffer_unmap".to_owned(), coverage_57 as *const u8),
        ("subscript_typegpu_buffer_destroy".to_owned(), coverage_58 as *const u8),
        ("subscript_typegpu_texture_create_view".to_owned(), coverage_59 as *const u8),
        ("subscript_typegpu_texture_set_label".to_owned(), coverage_60 as *const u8),
        ("subscript_typegpu_texture_get_width".to_owned(), coverage_61 as *const u8),
        ("subscript_typegpu_texture_get_height".to_owned(), coverage_62 as *const u8),
        ("subscript_typegpu_texture_get_depth_or_array_layers".to_owned(), coverage_63 as *const u8),
        ("subscript_typegpu_texture_get_mip_level_count".to_owned(), coverage_64 as *const u8),
        ("subscript_typegpu_texture_get_sample_count".to_owned(), coverage_65 as *const u8),
        ("subscript_typegpu_texture_get_dimension".to_owned(), coverage_66 as *const u8),
        ("subscript_typegpu_texture_get_texture_binding_view_dimension".to_owned(), coverage_67 as *const u8),
        ("subscript_typegpu_texture_get_format".to_owned(), coverage_68 as *const u8),
        ("subscript_typegpu_texture_get_usage".to_owned(), coverage_69 as *const u8),
        ("subscript_typegpu_texture_destroy".to_owned(), coverage_70 as *const u8),
        ("subscript_typegpu_texture_view_set_label".to_owned(), coverage_71 as *const u8),
        ("subscript_typegpu_sampler_set_label".to_owned(), coverage_72 as *const u8),
        ("subscript_typegpu_bind_group_layout_set_label".to_owned(), coverage_73 as *const u8),
        ("subscript_typegpu_bind_group_set_label".to_owned(), coverage_74 as *const u8),
        ("subscript_typegpu_pipeline_layout_set_label".to_owned(), coverage_75 as *const u8),
        ("subscript_typegpu_shader_module_set_label".to_owned(), coverage_76 as *const u8),
        ("subscript_typegpu_compute_pipeline_get_bind_group_layout".to_owned(), coverage_77 as *const u8),
        ("subscript_typegpu_compute_pipeline_set_label".to_owned(), coverage_78 as *const u8),
        ("subscript_typegpu_render_pipeline_get_bind_group_layout".to_owned(), coverage_79 as *const u8),
        ("subscript_typegpu_render_pipeline_set_label".to_owned(), coverage_80 as *const u8),
        ("subscript_typegpu_command_encoder_finish".to_owned(), coverage_81 as *const u8),
        ("subscript_typegpu_command_encoder_begin_compute_pass".to_owned(), coverage_82 as *const u8),
        ("subscript_typegpu_command_encoder_begin_render_pass".to_owned(), coverage_83 as *const u8),
        ("subscript_typegpu_command_encoder_copy_buffer_to_buffer".to_owned(), coverage_84 as *const u8),
        ("subscript_typegpu_command_encoder_copy_buffer_to_texture".to_owned(), coverage_85 as *const u8),
        ("subscript_typegpu_command_encoder_copy_texture_to_buffer".to_owned(), coverage_86 as *const u8),
        ("subscript_typegpu_command_encoder_copy_texture_to_texture".to_owned(), coverage_87 as *const u8),
        ("subscript_typegpu_command_encoder_clear_buffer".to_owned(), coverage_88 as *const u8),
        ("subscript_typegpu_command_encoder_resolve_query_set".to_owned(), coverage_89 as *const u8),
        ("subscript_typegpu_command_encoder_write_timestamp".to_owned(), coverage_90 as *const u8),
        ("subscript_typegpu_command_encoder_insert_debug_marker".to_owned(), coverage_91 as *const u8),
        ("subscript_typegpu_command_encoder_push_debug_group".to_owned(), coverage_92 as *const u8),
        ("subscript_typegpu_command_encoder_pop_debug_group".to_owned(), coverage_93 as *const u8),
        ("subscript_typegpu_command_encoder_set_label".to_owned(), coverage_94 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_set_pipeline".to_owned(), coverage_95 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_set_bind_group".to_owned(), coverage_96 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_dispatch_workgroups".to_owned(), coverage_97 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_dispatch_workgroups_indirect".to_owned(), coverage_98 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_insert_debug_marker".to_owned(), coverage_99 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_push_debug_group".to_owned(), coverage_100 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_pop_debug_group".to_owned(), coverage_101 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_end".to_owned(), coverage_102 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_set_label".to_owned(), coverage_103 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_pipeline".to_owned(), coverage_104 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_bind_group".to_owned(), coverage_105 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_vertex_buffer".to_owned(), coverage_106 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_index_buffer".to_owned(), coverage_107 as *const u8),
        ("subscript_typegpu_render_pass_encoder_draw".to_owned(), coverage_108 as *const u8),
        ("subscript_typegpu_render_pass_encoder_draw_indexed".to_owned(), coverage_109 as *const u8),
        ("subscript_typegpu_render_pass_encoder_draw_indirect".to_owned(), coverage_110 as *const u8),
        ("subscript_typegpu_render_pass_encoder_draw_indexed_indirect".to_owned(), coverage_111 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_viewport".to_owned(), coverage_112 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_scissor_rect".to_owned(), coverage_113 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_blend_constant".to_owned(), coverage_114 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_stencil_reference".to_owned(), coverage_115 as *const u8),
        ("subscript_typegpu_render_pass_encoder_begin_occlusion_query".to_owned(), coverage_116 as *const u8),
        ("subscript_typegpu_render_pass_encoder_end_occlusion_query".to_owned(), coverage_117 as *const u8),
        ("subscript_typegpu_render_pass_encoder_execute_bundles".to_owned(), coverage_118 as *const u8),
        ("subscript_typegpu_render_pass_encoder_insert_debug_marker".to_owned(), coverage_119 as *const u8),
        ("subscript_typegpu_render_pass_encoder_push_debug_group".to_owned(), coverage_120 as *const u8),
        ("subscript_typegpu_render_pass_encoder_pop_debug_group".to_owned(), coverage_121 as *const u8),
        ("subscript_typegpu_render_pass_encoder_end".to_owned(), coverage_122 as *const u8),
        ("subscript_typegpu_render_pass_encoder_set_label".to_owned(), coverage_123 as *const u8),
        ("subscript_typegpu_command_buffer_set_label".to_owned(), coverage_124 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_set_pipeline".to_owned(), coverage_125 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_set_bind_group".to_owned(), coverage_126 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_set_vertex_buffer".to_owned(), coverage_127 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_set_index_buffer".to_owned(), coverage_128 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_draw".to_owned(), coverage_129 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_draw_indexed".to_owned(), coverage_130 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_draw_indirect".to_owned(), coverage_131 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_draw_indexed_indirect".to_owned(), coverage_132 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_insert_debug_marker".to_owned(), coverage_133 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_push_debug_group".to_owned(), coverage_134 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_pop_debug_group".to_owned(), coverage_135 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_finish".to_owned(), coverage_136 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_set_label".to_owned(), coverage_137 as *const u8),
        ("subscript_typegpu_render_bundle_set_label".to_owned(), coverage_138 as *const u8),
        ("subscript_typegpu_query_set_get_type".to_owned(), coverage_139 as *const u8),
        ("subscript_typegpu_query_set_get_count".to_owned(), coverage_140 as *const u8),
        ("subscript_typegpu_query_set_destroy".to_owned(), coverage_141 as *const u8),
        ("subscript_typegpu_query_set_set_label".to_owned(), coverage_142 as *const u8),
        ("subscript_typegpu_query_set_release".to_owned(), coverage_143 as *const u8),
        ("subscript_typegpu_render_bundle_release".to_owned(), coverage_144 as *const u8),
        ("subscript_typegpu_render_bundle_encoder_release".to_owned(), coverage_145 as *const u8),
        ("subscript_typegpu_command_buffer_release".to_owned(), coverage_146 as *const u8),
        ("subscript_typegpu_render_pass_encoder_release".to_owned(), coverage_147 as *const u8),
        ("subscript_typegpu_compute_pass_encoder_release".to_owned(), coverage_148 as *const u8),
        ("subscript_typegpu_command_encoder_release".to_owned(), coverage_149 as *const u8),
        ("subscript_typegpu_render_pipeline_release".to_owned(), coverage_150 as *const u8),
        ("subscript_typegpu_compute_pipeline_release".to_owned(), coverage_151 as *const u8),
        ("subscript_typegpu_shader_module_release".to_owned(), coverage_152 as *const u8),
        ("subscript_typegpu_pipeline_layout_release".to_owned(), coverage_153 as *const u8),
        ("subscript_typegpu_bind_group_release".to_owned(), coverage_154 as *const u8),
        ("subscript_typegpu_bind_group_layout_release".to_owned(), coverage_155 as *const u8),
        ("subscript_typegpu_sampler_release".to_owned(), coverage_156 as *const u8),
        ("subscript_typegpu_texture_view_release".to_owned(), coverage_157 as *const u8),
        ("subscript_typegpu_texture_release".to_owned(), coverage_158 as *const u8),
        ("subscript_typegpu_buffer_release".to_owned(), coverage_159 as *const u8),
        ("subscript_typegpu_queue_release".to_owned(), coverage_160 as *const u8),
        ("subscript_typegpu_device_release".to_owned(), coverage_161 as *const u8),
        ("subscript_typegpu_adapter_release".to_owned(), coverage_162 as *const u8),
    ]
}
