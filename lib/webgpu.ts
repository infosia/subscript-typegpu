...
// - GPUVertexState.entryPoint: JavaScript can omit entryPoint when exactly one matching shader entry can be inferred, while this API requires the entry-point name explicitly
...
// - GPUFragmentState.entryPoint: JavaScript can omit entryPoint when exactly one matching shader entry can be inferred, while this API requires the entry-point name explicitly
